...
.
I was less happy with the plots. As you can see, the model struggled to successfully model the data points. I was not discouraged however, as I had one more trick up my sleeve... the Neural Network. 
